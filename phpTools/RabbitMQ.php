...
configs=array(′host′=>′127.0.0.1′,′port′=>5672,′username′=>′asdf′,′password′=>′123456′,′vhost′=>′/′);exchange_name = 'class-e-1';
queuename=′class−q−1′;route_key = 'class-r-1';
ra=newRabbitMQCommand(configs,exchangename,queue_name,routekey);for(i=0;i<=100;i++){
